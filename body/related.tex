...
In supervised sett, since (Miklov, 2013) show the availability of linear mapping in embedding alignment, 
	many other studies has / had tried to refine the transformation function to improve alignment accuracy. 
(Xing, 2015) put forward the inconsistency problem caused by improper distance metric of inner product, and solve it by replacing inner product by normalization and orthogonal transform. 
Beside mapping with a transformation matrix directly, (Fairqui, 2014; Artetxe, 2016; Lifu, 2018) tried mapping different languages into a common space. Some other mapping methods also have been proposed, for example, (Lazaridou, 2015) use max-margin to avoid hubness problem and non-linear projection method has also been explored by (Chandar A P, 2014). 
